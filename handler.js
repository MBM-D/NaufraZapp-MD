...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '⚠️ 𝗡𝗔𝗨𝗙𝗥𝗔𝗭𝗔𝗣𝗣 - 𝗠𝗗 ⚠️', body: 'Bot de WhatsApp automático', thumbnail: imagen7, sourceUrl: 'https://whatsapp.com/channel/0029VaRibRvDuMRj6ozMSN1l'}}}}, aa);
