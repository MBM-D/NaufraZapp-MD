...
if (isAdmin) return conn.sendMessage(m.chat, { text: `『✦』El admin: @${m.sender.split("@")[0]} acaba de enviar un texto que contiene muchos caracteres*`, mentions: [m.sender] }, { quoted: fkontak })
