...
if (prohibited.some(word => m.text.toLowerCase().includes(word))) return conn.reply(m.chat, '⚠️ • 𝘽𝙪𝙨𝙘𝙖𝙩𝙚 𝙚𝙨𝙖𝙨 𝙘𝙤𝙨𝙖𝙨 𝙥𝙤𝙧 𝙜𝙤𝙤𝙜𝙡𝙚...', fkontak, m )

if (!text) return conn.reply(m.chat, `☁️ • 𝙄𝙣𝙜𝙧𝙚𝙨𝙚 𝙪𝙣 𝙩𝙚𝙭𝙩𝙤 𝙥𝙖𝙧𝙖 𝙪𝙨𝙖𝙧 𝙚𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤, 𝙥𝙤𝙧 𝙚𝙟𝙚𝙢𝙥𝙡𝙤: #imagen Gato`, fkontak, m )
m.react(done)
