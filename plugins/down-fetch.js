...
if (!text) { return conn.reply(m.chat, `*『✦』Ingrese cualquier enlace por favor, por ejemplo:*\n\n#get https://www.atombio.com`, m, fakes, )}
...
return conn.reply(m.chat, `*『✦』Error, son demasiados redirecciones.*\n『✦』Maximo: _(${maxRedirects})_`, m, fake, )
}
