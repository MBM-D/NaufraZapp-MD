...
global.imgAll = [img, img1, img2, img3, img4, img5, img6, img7, img8, img9, img10, imagen1, imagen2, imagen3, nz1, nz2, nz3, nz4, nz5, nz6].getRandom()
global.naufraAll = [yt, ig, grupo1, grupo2, paypal, linkwabot, canal].getRandom()
global.nzLink = [grupo1, grupo2, canal].getRandom()
global.nzMenus = [imagen1, imagen2, imagen3].getRandom()
global.naufraImg = [nz1, nz2, nz3, nz4, nz5, nz6].getRandom()
...
global.fgclink = {key: {participant: "0@s.whatsapp.net", remoteJid: "0@s.whatsapp.net" }, message: { groupInviteMessage: { groupJid: "6288213840883-1616169743@g.us", inviteCode: "m", groupName: "NaufraZapp-MD", caption: `${wm}\n      ${wm}`, jpegThumbnail: imagen1}}}

global.fproducto2 = { key: { fromMe: false, participant: "0@s.whatsapp.net", ...(false ? { remoteJid: "status@broadcast" } : {})}, message: { productMessage: { product: { productImage: { mimetype: "image/jpeg", jpegThumbnail: imagen1}, title: `${wm}`, retailerId: "NaufraZapp-MD", productImageCount: 1 }, businessOwnerJid: "0@s.whatsapp.net" }}}	
	
global.fproducto = { key: { fromMe: false, participant: "0@s.whatsapp.net", ...(false ? { remoteJid: "17608914335@s.whatsapp.net" } : {}) }, message: { productMessage: { product: { productImage:{ "mimetype": "image/jpeg", jpegThumbnail: imagen1 }, title: `${wm}`, description: "NaufraZapp-MD", currencyCode: "USD", priceAmount1000: "200000000", retailerId: "Ghost", productImageCount: 1 }, businessOwnerJid: "0@s.whatsapp.net" }}}
...
global.fake = { key: { fromMe: false, participant: "0@s.whatsapp.net", ...(false ? { remoteJid: "5493873687620@s.whatsapp.net" } : {}) }, message: { productMessage: { product: { productImage:{ "mimetype": "image/jpeg", jpegThumbnail: imagen1 }, title: `${wm}`, description: "🌎 𝙉𝙖𝙪𝙛𝙧𝙖𝙕𝙖𝙥𝙥-𝘽𝙚𝙩𝙖 🌎", currencyCode: "USD", priceAmount1000: "200000000", retailerId: "Ghost", productImageCount: 1 }, businessOwnerJid: "19145948340@s.whatsapp.net" }}} //fake con reenviado de canal
}
