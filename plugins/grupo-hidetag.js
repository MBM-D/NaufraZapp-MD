...
**/
    ...
    const htextos = `${text ? text : '*『❌』Error, intente de nuevo.*'}`;
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://github.com/egobot-supreme/NaufraZapp-MD'}}}}}, {});
    }
  }
};
