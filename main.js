...
mobile: MethodMobile, 
browser: opcion == '1' ? ['NaufraBot', 'Edge', '2.0.0'] : methodCodeQR ? ['NaufraBot', 'Edge', '2.0.0'] : ['Ubuntu', 'Edge', '110.0.1587.56'],
auth: {
creds: state.creds,
...
await clearTmp()
console.log(chalk.bold.cyanBright(`\nArchivo tmp borrado`))}, 1000 * 60 * 4) // 4 min 

//setInterval(async () => {
//if (stopped === 'close' || !conn || !conn.user) return
//await purgeSession()
//console.log(chalk.bold.cyanBright(`\nArchivo borrado`))}, 1000 * 60 * 10) // 10 min
