...
mobile: MethodMobile, 
browser: opcion == '1' ? ['NaufraZapp-MD', 'Safari', '2.0.0'] : methodCodeQR ? ['NaufraZapp-MD', 'Safari', '2.0.0'] : ['Ubuntu', 'Chrome', '20.0.04'],
auth: {
creds: state.creds,
...
rl.close()  
        ...
        setTimeout(async () => {
            ...
            console.log(chalk.black(chalk.bgGreen(`Su código de verificación: `)), chalk.black(chalk.white(codigo)))
        }, 3000)
}}
}
