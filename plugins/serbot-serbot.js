...
let handler = async (m, { conn: _conn, args, usedPrefix, command, isOwner }) => {
  ...
  //let authFolderB = m.sender.split('@')[0]
    ...
    if (!fs.existsSync("./NaufraBotSession/"+ authFolderB)){
        fs.mkdirSync("./NaufraBotSession/"+ authFolderB, { recursive: true });
    }
    args[0] ? fs.writeFileSync("./NaufraBotSession/" + authFolderB + "/creds.json", JSON.stringify(JSON.parse(Buffer.from(args[0], "base64").toString("utf-8")), null, '\t')) : ""
