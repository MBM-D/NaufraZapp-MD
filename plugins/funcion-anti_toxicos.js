...
user.warn += 1
if (!(user.warn >= 4))
await m.reply(`${user.warn == 1 ? `⚠️ • *@${m.sender.split`@`[0]}*` : `*@${m.sender.split`@`[0]}*`}, decir la palabra (${isToxic}) está prohibido *${user.warn}/4* Advertencia(s)`, false, {mentions: [m.sender]})
}
