...
global.dfail = (type, m, conn) => {
  const msg = {
    ...
    admin: '╭•⌑┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈•⌑\n│🔒     `𝐀𝐃𝐕𝐄𝐑𝐓𝐄𝐍𝐂𝐈𝐀`      🔒\n╰•⌑┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈•⌑\n\n『✦』𝙀𝙨𝙩𝙚 𝙘𝙤𝙢𝙖𝙣𝙙𝙤 𝙨𝙤𝙡𝙤 𝙥𝙪𝙚𝙙𝙚 𝙨𝙚𝙧 𝙚𝙟𝙚𝙘𝙪𝙩𝙖𝙙𝙤 𝙥𝙤𝙧 𝙡𝙤𝙨 𝙖𝙙𝙢𝙞𝙣𝙨 𝙙𝙚𝙡 𝙜𝙧𝙪𝙥𝙤.',
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '⚠️ 𝗡𝗔𝗨𝗙𝗥𝗔𝗭𝗔𝗣𝗣 - 𝗠𝗗 ⚠️', body: 'Bot de WhatsApp automático', thumbnail: imgAll, sourceUrl: 'https://whatsapp.com/channel/0029VaRibRvDuMRj6ozMSN1l'}}}}, aa);
