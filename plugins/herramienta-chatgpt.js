...
if (!text) return conn.reply(m.chat, `『✦』Ingresa un texto para hablar con ChatGPT, por ejemplo: #${command} Codigo en JS para un juego de cartas`, m, fpay, ) 
...
try {
let syms1 = `Actuaras como un Bot de WhatsApp el cual fue creado por Bots-WhatsApp-OFC, tu seras NaufraZapp-MD`
