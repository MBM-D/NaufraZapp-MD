...
if (!text) return conn.reply(m.chat, '『✦』𝙄𝙣𝙜𝙧𝙚𝙨𝙚 𝙚𝙡 𝙣𝙤𝙢𝙗𝙧𝙚 𝙙𝙚 𝙡𝙖 𝙖𝙥𝙠 𝙦𝙪𝙚 𝙦𝙪𝙞𝙚𝙧𝙚 𝙗𝙪𝙨𝙘𝙖𝙧.', fkontak, m )
...
return await conn.reply(m.chat, '『✦』𝙀𝙡 𝙖𝙧𝙘𝙝𝙞𝙫𝙤 𝙚𝙨 𝙢𝙪𝙮 𝙥𝙚𝙨𝙖𝙙𝙤.', fkontak, m )
}
await conn.sendMessage(m.chat, {document: {url: data5.dllink}, mimetype: 'application/vnd.android.package-archive', fileName: data5.name + '.apk', caption: null}, {quoted: m})
} catch {
return conn.reply(m.chat, '『✦』𝙀𝙧𝙧𝙤𝙧 𝙖𝙡 𝙗𝙪𝙨𝙘𝙖𝙧 𝙚𝙡 𝙖𝙥𝙠.', fkontak, m )
}    
}
