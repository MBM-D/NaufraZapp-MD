...
var txt = `『✦』Estado del bot.

Próximamente...`

conn.relayMessage(m.chat, { extendedTextMessage:{ text: txt, contextInfo: { externalAdReply: { title: '𝗘𝗦𝗧𝗔𝗗𝗢 : 𝗦𝗧𝗔𝗧𝗨𝗦', mediaType: 1, previewType: 0, renderLargerThumbnail: true, thumbnailUrl: 'https://qu.ax/Pbha.mp4', sourceUrl: '' }}, mentions: [m.sender] }}, {})

console.log(OS)
} catch (e) {
console.log(e)
conn.reply(m.chat, '『✦』Ocurrio un error al mostrar el estado.', m, fpay, )}
