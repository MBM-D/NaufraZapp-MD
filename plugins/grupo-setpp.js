function _0x278b() {
  ...
  const _0x1a6abe=_0x375c; try {
    ...
    } const {img: _0x4fe079}=await _0x533f90(_0x3ae092); await _0x161b4f[_0x1a6abe(0x1bb)]({'tag': 'iq', 'attrs': {'to': _0x35ce56, 'type': 'set', 'xmlns': _0x1a6abe(0x1cd)}, 'content': [{'tag': _0x1a6abe(0x1cf), 'attrs': {'type': _0x1a6abe(0x1c1)}, 'content': _0x4fe079}]}), _0x394eb8[_0x1a6abe(0x1d6)]('*『✅』Se\x20ha\x20cambiado\x20la\x20img\x20del\x20grupo\x20con\x20exito.*');
  } catch {
    throw _0x1a6abe(0x1ce);
  }
}; handler[_0x3985f9(0x1b5)]=[_0x3985f9(0x1c3)], handler[_0x3985f9(0x1c6)]=['group', _0x3985f9(0x1c9)], handler[_0x3985f9(0x1b7)]=[_0x3985f9(0x1d7), _0x3985f9(0x1c3), _0x3985f9(0x1c5)], handler[_0x3985f9(0x1d0)]=/^setfoto(gc|grup|group)$/i, handler[_0x3985f9(0x1c8)]=handler['admin']=handler[_0x3985f9(0x1b6)]=!![]; export default handler;
