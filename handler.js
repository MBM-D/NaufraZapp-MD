...
global.dfail = (type, m, conn) => {
  ...
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: wm, body: '• Advertencia •', thumbnail: imagen1, sourceUrl: 'https://whatsapp.com/channel/0029VaRibRvDuMRj6ozMSN1l'}}}}, aa);
